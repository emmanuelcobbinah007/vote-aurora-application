...
const Sidebar = () => {
  ...
  useEffect(() => {
    if (isClient) {
      const id = session?.user?.id || (params.orchestratorId as string) || "";
      setUserId(id);
    }
  }, [isClient, session, params.orchestratorId]);
      ...
      <div className="w-64 h-screen bg-white border-r border-gray-200 flex items-center justify-center">
        <div className="text-center text-gray-500">
          ...
          <button
            ...
            className="mt-2 text-[#2ecc71] hover:text-green-800"
          >
            Return to Login
          </button>
        </div>
      ...
      items: [
        {
          ...
          href: `/orchestrator/${userId}/dashboard`,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          href: `/orchestrator/${userId}/manage-orchestrators`,
        },
        {
          icon: Users,
          activeIcon: Users2,
          label: "Manage Approver",
          href: `/orchestrator/${userId}/approver`,
        },
        {
          icon: Shield,
          activeIcon: ShieldCheck,
          label: "Manage SuperAdmin",
          href: `/orchestrator/${userId}/superadmin`,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          activeIcon: File,
          label: "Audit Log",
          href: `/orchestrator/${userId}/audit-log`,
        },
      ],
    },
  ];
