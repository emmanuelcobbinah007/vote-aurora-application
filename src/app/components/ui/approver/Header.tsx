  ...
  const searchableItems: SearchResult[] = [
    {
      ...
      description: "View statistics and recent approval activity",
      type: "page",
      url: `/approver`,
    ...
    },
    {
      ...
      type: "page",
      url: `/approver/${approverId}/pending`,
      icon: <FileText className="w-4 h-4" />,
    },
    {
      id: "approved",
      title: "Approved Elections",
      description: "View history of all approved elections",
      type: "page",
      url: `/approver/${approverId}/approved`,
      icon: <Shield className="w-4 h-4" />,
    },
    // Optional quick action
    {
      id: "review-next",
      title: "Review Next Pending",
      description: "Jump to the next pending approval item",
      type: "action",
      url: `/approver/${approverId}/pending?next=true`,
